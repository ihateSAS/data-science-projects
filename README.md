...
**Topics:** `classification` `fairness` `bias` `mental-health` `scikit-learn`
...
**Best model:** Logistic Regression — ROC-AUC 0.94

**Topics:** `classification` `clustering` `feature-importance` `student-wellbeing` `scikit-learn`

🔗 [Kaggle Notebook](https://www.kaggle.com/code/danieljhuang/can-student-schedules-predict-burnout/notebook)
